<!-- generated: 2026-05-29T03:00:10.379698+09:00 -->
...
### Markdown wiki vs typed graph
- Markdown wiki: easy to inspect, edit, diff, and commit.
- Typed graph: better for relationship traversal, validity windows, permissions, and structured invalidation.
- Likely synthesis: Markdown remains useful as an interface and audit layer, while graphs handle runtime memory queries.

### Retrieval vs memory system of record
- Retrieval answers "what text is similar to this query
